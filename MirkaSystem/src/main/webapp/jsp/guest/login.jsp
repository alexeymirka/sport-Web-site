...
<form name="logInForm" method="post" action="<c:url value="/controller"/>">
    ...
    <a class="inactive underlineHover" href="${pageContext.request.contextPath}/jsp/guest/register.jsp" >Register </a>
    ...
    <input type="submit" value="Log In" class="fadeIn fourth">
